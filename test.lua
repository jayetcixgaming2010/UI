...
-- WEBHOOK
local reportWebhookURL = "https://discordapp.com/api/webhooks/"
local ideasWebhookURL = "https://discordapp.com/api/webhooks/"
...
Library = loadstring(game:HttpGet("https://pastefy.app/bh23oFoG/raw"))()

Window = Library:CreateWindow({
    Title = "SynTrax Hub",
    Subtitle = "- Blox Fruit",
    Image = "rbxassetid://126329543253349"
})
...
Library:Notify({
    Title = "SynTrax Hub",
    Description = "The UI automatically hides once executed.\nPress the button at the bottom-left of the screen to show the GUI, Source: nazux. ",
    Duration = 3
})
