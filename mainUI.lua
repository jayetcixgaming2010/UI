...
function Library:NewWindow(ConfigWindow)
	...
	local ConfigWindow = self:MakeConfig({
		...
		Description = "By kiengodvippropvp_81236",
	...
	if _G.ThemeID and tostring(_G.ThemeID) ~= "" then
	...
	Line.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
	...
	LogoHub.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
	...
	Icon.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
	...
	Icon_2.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
	...
	Close.MouseButton1Down:Connect(function()
		...
		tat_["BorderColor3"] = Color3.fromRGB(0, 255, 247);
	...
	Icon_3.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
	...
	UIStroke.Color = Color3.fromRGB(0, 255, 247)
	...
	Line_2.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
	...
	IconSearch.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
	...
	function Tab:T(t, iconid)
		...
		Choose_2.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
		...
		function TabFunc:AddSection(RealNameSection)
			...
			UIGradient.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 24, 25)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(0, 255, 247)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 24, 25)) }
			...
			function SectionFunc:AddToggle(cftoggle)
				...
				function ToggleFunc:Set(Boolean)
					...
					if Boolean then
						...
						Library:TweenInstance(ToggleCheck, 0.3, "BackgroundColor3", Color3.fromRGB(0, 255, 247))
			...
			function SectionFunc:AddButton(cfbutton)
				...
				ImageLabel.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
			...
			function SectionFunc:AddDropdown(cfdropdown)
				...
				function DropFunc:Add(v)
					...
					UIGradient_3.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.51, Color3.fromRGB(0, 255, 247)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) }
			...
			function SectionFunc:AddSlider(cfslider)
				...
				SliderDraggable.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
			...
			function SectionFunc:AddDiscord(DiscordTitle, InviteCode)
				...
				Icon.Image = "rbxassetid://80900795508277" -- Icone do Discord
				...
				Title.Font = Enum.Font.GothamBold
				Title.Text = DiscordTitle or "Tsunami Hub"
				Title.TextColor3 = Color3.fromRGB(255, 255, 255)
				Title.TextSize = 14
				...
				JoinBtn.BackgroundColor3 = Color3.fromRGB(88, 101, 242) -- Azul Discord
