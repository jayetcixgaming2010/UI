if (game:GetService("CoreGui")):FindFirstChild("YNhub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).YNhub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(100, 100, 100);
_G.Dark = Color3.fromRGB(22, 22, 26);
_G.Third = Color3.fromRGB(0, 255, 255);
...
ImageButton.Image = "rbxassetid://134852113716171";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("YNhub")).Enabled = not (game.CoreGui:FindFirstChild("YNhub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://134852113716171";
	Title.Parent = Frame;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("YNhub") then
			makefolder("YNhub");
		end;
		if not isfolder("YNhub/Library/") then
			makefolder("YNhub/Library/");
		end;
		if not isfile(("YNhub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("YNhub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("YNhub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("YNhub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("YNhub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local YNhub = Instance.new("ScreenGui");
	YNhub.Name = "YNhub";
	YNhub.Parent = game.CoreGui;
	YNhub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = YNhub;
	...
	function CreateCheckbox(title, state, callback)
		...
		Checkbox.MouseButton1Click:Connect(function()
			...
			if checked then
				...
				Checkbox.BackgroundColor3 = Color3.fromRGB(0, 255, 255);
			else
				Checkbox.ImageTransparency = 1;
				Checkbox.BackgroundColor3 = Color3.fromRGB(100, 100, 100);
			end;
	...
	function uitab:Tab(text, img)
		...
		function main:Seperator(text)
			...
			Sep1.RichText = true;
			Sep1.Text = "Bearhud<font color=\"rgb(0, 255, 255)\">Bearhud</font>";
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(0, 255, 255)\">Bearhud</font>Bearhud";
